...
trait ResponseHelpers
{
    ...
    protected function respondSuccess($data = null, $message = 'success',$statusCode=200)
    {
        ...
        return $this->respond($data, $message, $statusCode);
    }
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    protected function respond($data, $message = null, $status = Response::HTTP_OK, array $headers = [], $options = JSON_NUMERIC_CHECK)
    {
        return $this->jsonResponse(
