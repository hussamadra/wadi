                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post"  id="repeat"
                              action="{{route('branches.update',$branche->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row d-flex align-items-end pb-1 pt-2 ةف-4">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{$branche->name}}" required />
                                </div>
                            </div>
                            ...
                            <div class="row d-flex align-items-end pb-1 pt-2 ةف-4">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="amount" value="{{$branche->amount}}" required />
                                </div>
                            </div>
