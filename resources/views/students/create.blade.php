                        ...
                        <form method="post"  id="repeat"
                            ...
                            <div class="row d-flex align-items-end pb-1 pt-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="father_name_en" required />
                                </div>
                            </div>
                            <div class="row d-flex align-items-end pb-1 pt-2">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="mother_name_en" required />
                                </div>
                            </div>
                            <div class="row d-flex align-items-end pb-1 pt-2">
                                <div class="col-md-12">
                            ...
                            <div class="row d-flex align-items-end pb-1 pt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="nation_no" required
                                        />
                                </div>
                                <div class="col-md-3">
                                    <h6 class="invoice-to-title">الأمانة</h6>
                                    <input type="text" class="form-control" name="nation_no2" required
                                        />
                                </div>
                                <div class="col-md-3">
                                    <h6 class="invoice-to-title">القيد</h6>
                                    <input type="text" class="form-control" name="nation_no3" required
                                        />
                                </div>
                            </div>
                            <div class="row d-flex align-items-end pb-1 pt-2">
                            ...
                            <div class="row d-flex align-items-end pb-1 pt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="mobile2" required />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row d-flex align-items-end pb-1 pt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="f_work" required />
                                </div>
                                <div class="col-md-6">
                                    <h6 class="invoice-to-title">عمل الأم</h6>
                                    <input type="text" class="form-control" name="m_work" required />
                                </div>
                            </div>
                            <div class="row d-flex align-items-end pb-1 pt-2">
                                <div class="col-md-6">
