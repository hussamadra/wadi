                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post"  id="repeat"
                              action="{{route('ides.update',$ide->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <h3 class="text-center">{{ $ide->student->first_name }} {{ $ide->student->last_name }}</h3>
                            ...
                            <div class="row d-flex align-items-end pb-1 pt-2">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="deplom" value="{{ $ide->deplom }}" required />
                                </div>
                            </div>
