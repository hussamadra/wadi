                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post"  id="repeat"
                              action="{{route('specials.update',$special->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="row d-flex align-items-end pb-1 pt-2">
                                <div class="col-md-6">
                                    <h6 class="invoice-to-title">اسم الاختصاص</h6>
                                    <input type="text" class="form-control" name="name" value="{{$special->name}}" />
                                </div>
                                <div class="col-md-6">
                            ...
                            `   <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="year" value="{{$special->year}}" />
                                </div>
                            </div>
                            ...
                            `   <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="amount" value="{{$special->amount}}" />
                                </div>
                            </div>
