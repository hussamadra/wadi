                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post"  id="repeat"
                              action="{{route('receipts.store')}}?id={{ $student->id }}" enctype="multipart/form-data">
                            @csrf

                            <input type="text" class="form-control" name="student_name" value="{{ $student->first_name }} {{ $student->last_name }}" readonly required />
